"""Write the updated models.py file directly"""
...
with open('database/models.py', 'r', encoding='utf-8') as f:
    ...
    print(f"Has set_encrypted_password: {'set_encrypted_password' in content}")
    print(f"Has get_decrypted_password: {'get_decrypted_password' in content}")
    print(f"Has update_health_metrics: {'update_health_metrics' in content}")
